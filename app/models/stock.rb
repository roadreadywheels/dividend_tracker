...
class Stock < ApplicationRecord
  ...
  def self.quandl_api
    # @stocks = Stock.all
    # Quandl::ApiConfig.api_key = 'GVpmsSzLz8sedvB2WUAa'
    # Quandl::ApiConfig.api_version = '2018-01-28'

    # @stocks.each do |stock|
    #   data = Quandl::Dataset.get("WIKI/#{stock.ticker}").data(params: { limit: 1 }).first
